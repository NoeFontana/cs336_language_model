...
def snapshot(request):
    ...
    snapshot_handler.assert_match = patched_assert_match  # ty: ignore[invalid-assignment]
...
def numpy_snapshot(request):
    ...
    snapshot.assert_match = patched_assert_match  # ty: ignore[invalid-assignment]
