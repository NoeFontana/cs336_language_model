...
from cs336_basics.layer.feedforward import silu
from cs336_basics.layer.linear import Linear
from cs336_basics.layer.transformer import (
    MHSA,
    FeedForward,
    RMSNorm,
...
def run_train_bpe(
    ...
    **kwargs,  # noqa: ARG001
    ...
    pretokens = chunked_pretokenization(corpus_path=Path(input_path), special_tokens=special_tokens)
